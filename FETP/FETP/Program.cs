    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            while(true)
            {
                ...
                Console.WriteLine("4. Test Ben's Allstar GA    <---- will devour CPU like ice cream on a hot day (currently fails 80% of the time for some reason)"); // ? crashes every now and then. theres a bug somewhere...
